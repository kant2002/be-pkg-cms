...
This repository contains the package which provides cms capabilities.
...
In order to install and use the linked dependencies for `pkg-cms` the following command can be used:
